...
public class MybatisPlatformOptionsBean implements FactoryBean<MybatisPlatformOptions>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    private MybatisPlatformOptions targetPlatform;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.targetPlatform = buildMybatisPlatform();
    }

    protected MybatisPlatformOptions buildMybatisPlatform() throws Exception {
    ...
    @Override
    public MybatisPlatformOptions getObject() throws Exception {
