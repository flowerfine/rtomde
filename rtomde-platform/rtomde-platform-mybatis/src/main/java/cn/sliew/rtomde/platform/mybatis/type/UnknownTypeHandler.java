...
public class UnknownTypeHandler extends BaseTypeHandler<Object> {
    ...
    /**
     * The constructor that pass a MyBatis platform options.
     *
     * @param platform a MyBatis platform options.
     */
    public UnknownTypeHandler(MybatisPlatformOptions platform) {
        this.platform = platform;
        this.typeHandlerRegistrySupplier = platform::getTypeHandlerRegistry;
    }
    ...
    private TypeHandler<?> resolveTypeHandler(ResultSet rs, String column) {
        try {
            ...
            boolean useColumnLabel = platform.isUseColumnLabel();
