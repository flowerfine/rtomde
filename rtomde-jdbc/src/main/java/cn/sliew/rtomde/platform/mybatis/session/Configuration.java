...
import cn.sliew.rtomde.platform.mybatis.builder.CacheRefResolver;
...
import cn.sliew.rtomde.platform.mybatis.cache.impl.PerpetualCache;
...
import cn.sliew.rtomde.platform.mybatis.executor.ReuseExecutor;
...
import cn.sliew.rtomde.platform.mybatis.executor.loader.cglib.CglibProxyFactory;
...
import cn.sliew.rtomde.type.TypeAliasRegistry;
...
public class Configuration {
    ...
    protected Environment defaultEnv;
    /**
     * environmentId -> Environment
     */
    private Map<String, Environment> environmentRegistry = new ConcurrentHashMap<>(4);
...
//    protected final Map<String, ParameterMap> parameterMaps = new StrictMap<>("Parameter Maps collection");
    ...
    public void setDefaultEnv(Environment defaultEnv) {
        this.defaultEnv = defaultEnv;
    }

    public void addEnvironment(Environment env) {
        this.environmentRegistry.put(env.getId(), env);
    }
     ...
     * A default {@link TypeHandler} is {@link cn.sliew.rtomde.type.EnumTypeHandler}.
     *
