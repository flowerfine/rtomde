...
public enum AutoMappingUnknownColumnBehavior {
    ...
    /**
     * Output warning log.
     * Note: The log level of {@code 'cn.sliew.rtomde.platform.mybatis.session.AutoMappingUnknownColumnBehavior'} must be set to {@code WARN}.
     */
    WARNING {
        @Override
        public void doAction(MappedStatement mappedStatement, String columnName, String property, Class<?> propertyType) {
     ...
     * @param propertyType    property type for mapping target (If this argument is not null, {@link cn.sliew.rtomde.type.TypeHandler} for property type is not registered)
     */
