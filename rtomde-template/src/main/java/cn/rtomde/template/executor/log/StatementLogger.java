...
public final class StatementLogger extends BaseJdbcLogger implements InvocationHandler {
    ...
    private StatementLogger(Logger statementLog, Statement stmt) {
        super(statementLog);
        this.statement = stmt;
    }
...
//            throw ExceptionUtil.unwrapThrowable(t);
     ...
     * @return the proxy
     */
    public static Statement newInstance(Logger statementLog, Statement stmt) {
        InvocationHandler handler = new StatementLogger(statementLog, stmt);
